...
import com.example.testubi2.ubidots.Value.StatisticsFigures;

public class Variable extends com.example.testubi2.ubidots.ApiObject {
	...
	public String getLastValue() {
		Object rawLast = getRaw().get("last_value");

		if (rawLast instanceof Map) { // Ensure rawLast is a Map
			Object value = ((Map<?, ?>) rawLast).get("value"); // Retrieve the "value" key
		...
		// Return 0 if the value is null or if any type checks fail
		return "0";
	}
	...
	public com.example.testubi2.ubidots.Value[] getValues() {
		return getValues(null);
	}

	public com.example.testubi2.ubidots.Value[] getValues(Map<String, String> customParameters) {
		...
		com.example.testubi2.ubidots.Value[] values = new com.example.testubi2.ubidots.Value[rawValues.size()];
